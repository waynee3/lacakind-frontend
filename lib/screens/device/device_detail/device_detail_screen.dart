...
class DeviceDetailScreen extends StatelessWidget {
  ...
  const DeviceDetailScreen({super.key, required this.serialNumber});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) =>
          DeviceDetailBloc()..add(DeviceDetailEvent.started(serialNumber)),
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          e.eventType,
                                          style: textTheme.bodySmall?.semibold,
                                        ),
